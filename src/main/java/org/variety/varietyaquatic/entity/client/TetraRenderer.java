...
public class TetraRenderer extends GeoEntityRenderer<TetraEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(TetraEntity instance) {
        return new ResourceLocation(VarietyAquatic.MODID, "textures/entity/tetra_texture.png");
    }

    @Override
    public void render(TetraEntity entity, float entityYaw, float partialTick, PoseStack poseStack,
