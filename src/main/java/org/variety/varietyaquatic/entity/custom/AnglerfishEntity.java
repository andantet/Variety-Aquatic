...
public class AnglerfishEntity extends AbstractSchoolingFish implements IAnimatable {
    ...
    public AnglerfishEntity(EntityType<? extends AbstractSchoolingFish> pEntityType, Level pLevel) {
    ...
    public static boolean checkAnglerfishSpawnRules(EntityType<? extends LivingEntity> pType, ServerLevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
