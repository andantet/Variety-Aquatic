...
public class ClownfishEntity extends WaterAnimal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    private static final EntityDataAccessor<Integer> MOISTNESS_LEVEL = SynchedEntityData.defineId(ClownfishEntity.class, EntityDataSerializers.INT);

    public ClownfishEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
