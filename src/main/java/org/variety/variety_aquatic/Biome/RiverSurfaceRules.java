...
public class RiverSurfaceRules {
    ...
    public static MaterialRules.MaterialRule build() {
        ...
        MaterialRules.MaterialRule biomeSurface = MaterialRules.sequence(
                MaterialRules.condition(MaterialRules.biome(OceanBiomes.SANDY, OceanBiomes.TROPICAL), SAND),
                MaterialRules.condition(MaterialRules.biome(OceanBiomes.GRAVELLY), GRAVEL)
        );
