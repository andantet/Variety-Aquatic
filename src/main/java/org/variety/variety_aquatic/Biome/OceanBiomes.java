...
public class OceanBiomes {
    ...
    public static final RegistryKey<Biome> SANDY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(Variety_Aquatic.MOD_ID, "sandy_river"));
    public static final RegistryKey<Biome> GRAVELLY = RegistryKey.of(Registry.BIOME_KEY, new Identifier(Variety_Aquatic.MOD_ID, "gravelly_river"));
    public static final RegistryKey<Biome> TROPICAL = RegistryKey.of(Registry.BIOME_KEY, new Identifier(Variety_Aquatic.MOD_ID, "tropical_river"));
    public static final  RegistryKey<Biome> CARVED = RegistryKey.of(Registry.BIOME_KEY, new Identifier(Variety_Aquatic.MOD_ID, "carved_river"));
