...
public class RiverRegion extends Region {
    ...
    public void addBiomes
            (Registry<Biome> registry, Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> mapper) {
...
//        riverTargetN_I.forEach(point -> addBiome(mapper, point, RiverBiomes.SANDY));
        ...
        riverTargetC2F.forEach(point -> addBiome(mapper, point, OceanBiomes.SANDY));
        ...
        riverTargetC2F2.forEach(point -> addBiome(mapper, point, OceanBiomes.TROPICAL));
        ...
        riverTargetC2F3.forEach(point -> addBiome(mapper, point, OceanBiomes.GRAVELLY));
    }
}
