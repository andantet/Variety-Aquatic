...
public class BlueFinTunaRenderer extends GeoEntityRenderer<BluefinTuna> {
    ...
    @Override
    public Identifier getTextureLocation(BluefinTuna instance) {
        return new Identifier(Variety_Aquatic.MOD_ID, "textures/entity/bluefintuna_texture.png");
    }


    @Override
    public void preRender(MatrixStack poseStack, BluefinTuna animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
