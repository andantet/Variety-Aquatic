...
public class SpermwhaleRenderer extends GeoEntityRenderer<SpermwhaleEntity> {
    ...
    @Override
    public Identifier getTextureResource(SpermwhaleEntity instance) {
        return new Identifier(Variety_Aquatic.MOD_ID, "textures/entity/spermwhale_texture.png");
    }


    @Override
    public RenderLayer getRenderType(SpermwhaleEntity animatable, float partialTicks, MatrixStack stack,
