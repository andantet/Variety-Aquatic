...
public class MoonJellyRenderer extends GeoEntityRenderer<MoonJellyEntity> {
    ...
    @Override
    public Identifier getTextureLocation(MoonJellyEntity instance) {
        return new Identifier(Variety_Aquatic.MOD_ID, "textures/entity/moonjelly_texture.png");
    }


    @Override
    public void preRender(MatrixStack poseStack, MoonJellyEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
