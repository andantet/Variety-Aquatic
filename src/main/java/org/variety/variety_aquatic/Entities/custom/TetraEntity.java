...
public class TetraEntity extends SchoolingFishEntity implements IAnimatable {
    ...
    static {
        MOISTNESS = DataTracker.registerData(TetraEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    static class InWaterPredicate implements Predicate<LivingEntity> {
        private final TetraEntity owner;

        public InWaterPredicate(TetraEntity owner) {
            this.owner = owner;
        }
