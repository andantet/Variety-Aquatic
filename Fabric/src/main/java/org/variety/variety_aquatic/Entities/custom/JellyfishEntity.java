...
public class JellyfishEntity extends VarietyFish {
    ...
    class EscapeAttackerGoal extends Goal {
        ...
        public boolean canStart() {
            LivingEntity attacker = JellyfishEntity.this.getAttacker();
            return JellyfishEntity.this.isTouchingWater() && attacker != null && JellyfishEntity.this.squaredDistanceTo(attacker) < 100.0;
        }
        ...
        public void tick() {
            ...
            if (attacker != null) {
                ...
                if (fluidState.isIn(FluidTags.WATER) || blockState.isAir()) {
                    ...
                    JellyfishEntity.this.setSwimmingVector((float) (difference.x / SWIMMING_MULTIPLIER), (float) (difference.y / SWIMMING_MULTIPLIER), (float) (difference.z / SWIMMING_MULTIPLIER));
                }
